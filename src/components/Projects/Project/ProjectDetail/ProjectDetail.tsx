...
// import ReactHtmlParser from 'react-html-parser'; //npm install --save @types/react-html-parser для установки типов данного расширения
...
const ProjectDetail: React.FC<PropsType> = (props) => {
